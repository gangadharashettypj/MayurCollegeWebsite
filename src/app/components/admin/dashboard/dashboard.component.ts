...
export class DashboardComponent {
  ...
  ngOnInit(): void {
    ...
    this.http
      .get('https://mayurcollegewebsite.onrender.com/applications')
      .subscribe(
        (response) => {
          ...
          console.log(
            this.no_announcments,
            this.no_applications,
            this.no_images,
            this.no_messages,
            this.no_users
          );
    ...
    this.http
      .get('https://mayurcollegewebsite.onrender.com/getcontact')
      .subscribe(
        (response) => {
    ...
    this.http
      .get('https://mayurcollegewebsite.onrender.com/getannouncment')
      .subscribe(
        (response) => {
    ...
    this.http
      .get('https://mayurcollegewebsite.onrender.com/getEvent')
      .subscribe(
        (response) => {
  ...
  deleteContact(contactId: string) {
    const url =
      'https://mayurcollegewebsite.onrender.com/deletecontact/' + contactId;
  ...
  deleteImage(imageId: string) {
    const url =
      'https://mayurcollegewebsite.onrender.com/deleteImage/' + imageId;
    this.http.delete(url).subscribe(
      (response) => {
  ...
  deleteApplication(applicationId: string) {
    const url =
      'https://mayurcollegewebsite.onrender.com/deleteapplication/' +
      applicationId;
    this.http.delete(url).subscribe(
      (response) => {
        console.log(response);
  ...
  addAnnouncment() {
    ...
    this.http
      .post('https://mayurcollegewebsite.onrender.com/announcment', formData)
      .subscribe(
        (response) => {
  ...
  editAnnouncment() {
    ...
    this.http
      .put(
        'https://mayurcollegewebsite.onrender.com/editAnnouncement/' +
          this.id_edit,
        announcmentData
      )
      .subscribe(
  ...
  deleteAnnoncemnent(announcementId: string) {
    const url =
      'https://mayurcollegewebsite.onrender.com/deleteAnnouncment/' +
      announcementId;
    this.http.delete(url).subscribe(
      (response) => {
  ...
  addEvent() {
    ...
    // Send formData to your backend using HttpClient
    this.http
      .post('https://mayurcollegewebsite.onrender.com/event', eventData)
      .subscribe(
        (response) => {
          console.log('Application submitted successfully', response);
          this.ngOnInit();
  ...
  editEvent() {
    ...
    this.http
      .put(
        'https://mayurcollegewebsite.onrender.com/editEvent/' +
          this.id_edit_event,
        eventData
      )
      .subscribe(
  ...
  deleteEvent(eventId: string) {
    const url =
      'https://mayurcollegewebsite.onrender.com/deleteEvent/' + eventId;
    this.http.delete(url).subscribe(
      (response) => {
  ...
  onSubmitImage() {
    ...
    this.http
      .post('https://mayurcollegewebsite.onrender.com/upload', formData)
      .subscribe(
        (response) => {
  ...
  registerUser() {
    ...
    // Send formData to your backend using HttpClient
    this.http
      .post('https://mayurcollegewebsite.onrender.com/signup', registerData)
      .subscribe(
        (response) => {
  ...
  changePassword() {
    ...
    this.http
      .post(
        'https://mayurcollegewebsite.onrender.com/changepassword',
        changeData
      )
      .subscribe(
        (response) => {
