...
var Contact = require('../models/contact'); // Make sure to provide the correct path

var router = express.Router();

// POST request to submit an application
router.post('/contact', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          newContacts = new Contact(req.body);
          _context.next = 4;
...
router.get('/getcontact', /*#__PURE__*/function () {
...
router["delete"]('/deletecontact/:id', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var contactId, existingContact;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          contactId = req.params.id; // Check if the contact exists
          _context3.next = 4;
          return Contact.findById(contactId);
        case 4:
          existingContact = _context3.sent;
          if (existingContact) {
            _context3.next = 7;
            break;
          }
