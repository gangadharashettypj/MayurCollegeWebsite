...
var Gallery = require('../models/gallery'); // Make sure to provide the correct path
...
router.post('/upload', upload.single('image'), /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, title, description, imageFilename, newImage;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, title = _req$body.title, description = _req$body.description;
          imageFilename = req.file.filename; // Get the uploaded image filename
...
router.get('/getimages', /*#__PURE__*/function () {
...
router["delete"]('/deleteimage/:id', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var imageId, existingImage;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          imageId = req.params.id; // Check if the image exists
          _context3.next = 4;
          return Gallery.findById(imageId);
        case 4:
          existingImage = _context3.sent;
          if (existingImage) {
            _context3.next = 7;
            break;
          }
        ...
        case 12:
          ...
          console.error('Error deleting image:', _context3.t0);
          res.status(500).json({
            error: 'Internal server error'
          });
        case 16:
